...
Sentiment alignment:
    positive sentiment + BUY → full multiplier (sentiment_agree_mult)
    neutral  sentiment + BUY → reduced size   (sentiment_neutral_mult)
    negative sentiment + BUY → minimal size   (sentiment_disagree_mult)

Optional Kelly fraction cap from risk calculator.
"""
