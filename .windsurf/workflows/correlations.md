...
1. Run the standard 3-year correlation report:
   `mean_reversion\venv\Scripts\python.exe compute_correlations.py`
   Run from `c:\Users\ukard\OneDrive\Desktop\trading`.

2. For a 1-year short-term view (useful after market regime changes):
   `mean_reversion\venv\Scripts\python.exe compute_correlations.py --years 1`
   Run from `c:\Users\ukard\OneDrive\Desktop\trading`.

3. For a 5-year long-term view:
   `mean_reversion\venv\Scripts\python.exe compute_correlations.py --years 5`
   Run from `c:\Users\ukard\OneDrive\Desktop\trading`.
